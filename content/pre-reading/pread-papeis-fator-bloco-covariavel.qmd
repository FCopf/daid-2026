...
A lógica é a mesma do bloco, retirar do resíduo uma variação conhecida, mas o instrumento é diferente, porque em vez de agrupar unidades parecidas, mede-se a característica de cada uma. A @fig-bloco-covariavel põe as duas estratégias lado a lado.
...
Ajustados aos dois conjuntos da @fig-bloco-covariavel, os modelos com bloco e com covariável produzem tabelas de coeficientes com estrutura diferente, embora o comando seja quase o mesmo.
...
Uma forma de tornar isso visível é retirar de $X_1$ sua previsão por $X_2$, retirar de $Y$ sua previsão por $X_2$ e relacionar os dois conjuntos de resíduos, como na @fig-coeficiente-parcial. A inclinação resultante é a mesma $\hat\beta_1$ do modelo múltiplo.
