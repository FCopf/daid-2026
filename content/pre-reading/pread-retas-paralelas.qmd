...
Duas retas podem se relacionar de três maneiras, reunidas na @fig-tres-cenarios, e vale saber reconhecê-las antes de olhar qualquer saída de modelo.
...
Olhe o painel da direita da @fig-tres-cenarios. Nos indivíduos pequenos as duas retas quase se tocam, e nos grandes estão bem separadas. Dizer "abril tem biomassa maior" é verdade em uma parte da faixa e quase falso na outra.
...
O produto $XG$ é a interação, e os três cenários da @fig-tres-cenarios correspondem a três configurações desses coeficientes. Há uma reta só quando $\beta_2=\beta_3=0$, retas paralelas quando apenas $\beta_3=0$, e inclinações diferentes quando $\beta_3\ne0$. Testar $H_0:\beta_3=0$ pergunta, então, se as retas podem ser consideradas paralelas.
...
Na @fig-diferenca-condicional, a linha central é $\hat\Delta(X)$ e a faixa é o seu intervalo de confiança, calculado apenas na região de comprimentos observada nos dois meses. Onde a faixa cruza a linha do zero, os dados não distinguem os meses, e onde ela fica inteiramente acima, distinguem. Uma única frase sobre "a diferença entre os meses" perderia justamente essa informação. O intervalo apresentado incorpora simultaneamente a incerteza dos interceptos, das inclinações e a covariância entre os coeficientes, o que é diferente de somar intervalos calculados separadamente para cada reta.
...
A @fig-suporte mostra a primeira situação em sua forma mais enganosa, em que todos os indivíduos seguem uma única relação curva, mas cada mês ocupa um trecho diferente dela.
