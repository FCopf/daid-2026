...
O histograma da @fig-distribuicao-nula está centrado em zero, como esperado, porque dois grupos idênticos não diferem em média. Mas ele é **largo**. Diferenças de 1 cm, de 2 cm e até maiores acontecem com alguma frequência, sem que exista qualquer efeito.
...
Aqui $\mu_0$ é o valor previsto por $H_0$ e $\sigma_{\bar{x}}=\sigma/\sqrt n=0{,}4$ cm é o erro padrão da média. A leitura verbal é que a média observada ficou dois erros padrão acima do valor nulo. Em um teste bilateral, o valor de p é $2P(Z\ge2)\approx0{,}0455$, que corresponde à área destacada nas duas caudas da @fig-caudas.
...
As linhas tracejadas da @fig-caudas, em aproximadamente $\pm1{,}96$, delimitam a região central que concentra 95% da distribuição nula. Como $Z=2$ ficou fora dela, o resultado seria declarado incompatível com $H_0$ ao nível de 5%. No cotidiano, $\sigma$ é quase sempre desconhecido e a distribuição t substitui a normal. O exemplo Z é uma lente para compreender a padronização, não uma recomendação automática de teste.
